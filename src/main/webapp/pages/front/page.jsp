...
<link rel="stylesheet" type="text/css" href="<%=basePath %>resources/css/uikit.css">
<link rel="stylesheet" type="text/css" href="<%=basePath %>resources/css/uikit.almost-flat.css">
